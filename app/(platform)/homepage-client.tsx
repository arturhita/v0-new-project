...
export default function HomepageClient({ operators, reviews, articles }: HomepageClientProps) {
  return (
    <div className="flex flex-col min-h-screen bg-slate-900 text-white overflow-x-hidden relative">
      ...
      <div className="relative z-10">
        {/* Hero Section */}
        <section
          className="relative flex min-h-[80vh] flex-col items-center justify-center bg-cover bg-center bg-no-repeat px-4 text-center"
        ...
        >
          ...
          <div className="relative z-10 animate-fadeInUp">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-300 md:text-xl">
              Connettiti con i migliori esperti di astrologia e tarocchi per una consulenza personalizzata.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <Button asChild variant="link" size="lg">
                <Link href="/diventa-esperto">
                  Diventa un esperto <span aria-hidden="true">→</span>
                </Link>
              </Button>
            </div>
          </div>
        ...
        <section
          id="esperti"
          className="py-16 md:py-24 relative bg-gradient-to-br from-blue-950 via-slate-900 to-blue-950 overflow-hidden"
        >
          <div className="container px-4 md:px-6 relative z-10">
            <h2 className="text-center text-3xl font-bold md:text-4xl text-white">I nostri esperti in primo piano</h2>
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
              {operators.map((operator) => (
                <div key={operator.id} className="animate-scaleIn">
        ...
        {/* AstroMag Section */}
        <section id="astromag" className="py-16 bg-slate-900/50">
          <div className="container mx-auto px-4">
