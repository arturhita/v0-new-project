  ...
  return (
    <div className="bg-gradient-to-b from-[#0a1a5c] via-[#1E3C98] to-[#3a5fcf] text-white">
      ...
      <section className="relative text-center py-20 md:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#0a1a5c]"></div>
        <div className="container relative">
          <Sparkles className="w-12 h-12 text-cyan-400 mx-auto mb-4 animate-pulse" />
          <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight">Scopri il tuo futuro, oggi.</h1>
          <p className="text-lg md:text-xl text-blue-200 max-w-3xl mx-auto mb-8">
            Connettiti con i migliori esperti di cartomanzia e astrologia. Ricevi consulti personalizzati in chat o al
            telefono, quando vuoi tu.
          </p>
          <div className="flex justify-center gap-4">
            <Button
              asChild
              size="lg"
              className="bg-cyan-400 text-blue-900 hover:bg-cyan-300 rounded-full px-8 py-6 text-lg font-semibold"
            >
              <Link href="/esperti/tutti">
                Trova il tuo esperto <ArrowRight className="w-5 h-5 ml-2" />
              </Link>
            </Button>
            <Button
              asChild
              size="lg"
              variant="outline"
              className="border-cyan-400 text-cyan-400 hover:bg-cyan-400/10 rounded-full px-8 py-6 text-lg font-semibold bg-transparent"
            >
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold flex items-center justify-center gap-3">
              <Users className="w-8 h-8 text-cyan-400" />I nostri Esperti in Primo Piano
            </h2>
