...
// NOTA: I dati mock verranno sostituiti da getOperators, ma li teniamo per la sezione "Nuovi Talenti" per ora.
...
export default async function UnveillyHomePage() {
  ...
  // Usiamo i dati reali per la sezione principale
  const operators = await getOperators({ limit: 8 })

  // Usiamo i dati mock per la sezione "Nuovi Talenti" come prima
