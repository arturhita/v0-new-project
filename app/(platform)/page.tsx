...
export default async function HomePage() {
  ...
  return (
    <div className="relative bg-slate-900 text-white">
      ...
      {/* Hero Section */}
      <section className="relative container mx-auto px-4 py-24 md:py-32 text-center z-10">
        <h1 className="text-4xl md:text-6xl font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-b from-white to-slate-300">
          Il Tuo Futuro, Svelato.
        </h1>
        <p className="mt-4 max-w-2xl mx-auto text-lg text-slate-300">
          Connettiti con i migliori esperti di astrologia, tarocchi e numerologia. La tua guida personale per un domani
          più chiaro.
        </p>
        <div className="mt-8 flex justify-center gap-4">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="border-slate-400 text-white hover:bg-white/10 bg-transparent"
          >
      ...
      <section className="relative container mx-auto px-4 py-16 z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold tracking-tight">I Nostri Esperti in Evidenza</h2>
          <p className="mt-2 text-slate-400">Professionisti pronti ad ascoltarti e guidarti.</p>
        </div>
        ...
        {operators.length > 0 ? (
          ...
          <div className="text-center py-10 bg-slate-800/50 rounded-lg">
            <p className="text-slate-400">Nessun operatore disponibile al momento. Riprova più tardi.</p>
          </div>
        )}

        <div className="text-center mt-12">
          <Button asChild variant="ghost" className="text-slate-300 hover:text-white hover:bg-white/10">
            <Link href="/esperti/tutti">Vedi tutti gli esperti &rarr;</Link>
          </Button>
        </div>
      </section>
