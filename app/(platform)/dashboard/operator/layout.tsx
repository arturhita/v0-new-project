    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="w-64 bg-gray-200 p-4">
        ...
        <nav>
          <ul>
            <li className="mb-2">
              <a href="/dashboard/operator" className="hover:text-blue-500">
                Overview
              </a>
            </li>
            <li className="mb-2">
              <a href="/dashboard/operator/users" className="hover:text-blue-500">
                Users
              </a>
            </li>
            <li className="mb-2">
              <a href="/dashboard/operator/settings" className="hover:text-blue-500">
                Settings
              </a>
            </li>
          </ul>
