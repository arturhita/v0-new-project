...
const NavItem = ({ item, pathname }: { item: (typeof navItemsOperator)[0]; pathname: string }) => {
  // Logica di attivazione corretta per gestire le route nidificate
  const isActive = item.href === "/dashboard/operator" ? pathname === item.href : pathname.startsWith(item.href)
...
const SidebarContent = () => {
  ...
  return (
    <div className="flex h-full max-h-screen flex-col">
      ...
      <nav className="flex-1 overflow-auto py-5 space-y-2 px-3">
