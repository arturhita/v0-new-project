...
import { Switch } from "@/components/ui/switch" // Usiamo Switch per Abilita/Disabilita
import { DollarSign, MessageSquare, Phone, Mail, Save, Clock } from "lucide-react"
...
interface ConsultationSettings {
  ...
  minDurationCallChat: number // Durata minima per chat e chiamate
...
export default function OperatorConsultationSettingsPage() {
  ...
  const handleSaveSettings = () => {
    // Qui, in un'app reale, invieresti i dati al backend
    console.log("Impostazioni salvate:", settings)
    toast({
      title: "Impostazioni Salvate",
      description: "Le tue preferenze di consulto sono state aggiornate.",
            ...
            <div className="p-4 border rounded-lg bg-slate-50/70">
              ...
              <div className="pl-7">
                ...
                <Input
                  ...
                  min="5"
                />
                <p className="text-xs text-slate-500 mt-1">Durata minima per sessioni di chat o chiamata.</p>
              </div>
            </div>
          )}
            ...
            {settings.emailEnabled && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pl-7">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">Tariffa fissa per un consulto scritto via email.</p>
                </div>
              </div>
            )}
          </div>
