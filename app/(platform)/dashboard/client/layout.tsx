...
export default async function ClientDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { label: "Portafoglio", href: "/dashboard/client/wallet" },
    { label: "I Miei Consulti", href: "/dashboard/client/consultations" },
    { label: "Messaggi", href: "/dashboard/client/messages" },
    { label: "Consulti Scritti", href: "/dashboard/client/written-consultations" },
    { label: "Le Mie Recensioni", href: "/dashboard/client/reviews" },
    { label: "Supporto", href: "/dashboard/client/support" },
  ]
