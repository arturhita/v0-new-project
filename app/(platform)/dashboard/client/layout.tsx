...
const NavItem = ({ item, pathname }: { item: (typeof navItemsClient)[0]; pathname: string }) => {
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        isActive ? "bg-blue-600 text-white shadow-md font-semibold" : "text-gray-700",
      )}
    >
        ...
        <header className="flex h-20 items-center gap-4 border-b border-gray-200 bg-white/95 backdrop-blur-sm px-4 md:px-6 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <Avatar className="h-10 w-10 border-2 border-blue-200">
              <AvatarImage src={user?.avatarUrl || "/placeholder.svg?height=38&width=38"} alt={user?.name || "User"} />
