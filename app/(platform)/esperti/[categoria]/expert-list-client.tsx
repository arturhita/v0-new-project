...
interface ExpertListClientProps {
  initialOperators: OperatorCardData[]
  categoryDetails: {
    title: string
    description: string
  }
...
export function ExpertListClient({ initialOperators, categoryDetails }: ExpertListClientProps) {
  ...
  const filteredOperators = useMemo(() => {
    ...
    let searchedOperators = initialOperators
    if (searchTerm) {
