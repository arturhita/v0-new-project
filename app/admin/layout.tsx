...
const navItems = [
  ...
  { href: "/admin/blog-management", label: "Blog", icon: BookOpen },
...
const SidebarNav = ({ links, pathname }: { links: any; pathname: string }) => (
...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <ProtectedRoute requiredRole="admin">
      <DashboardLayout links={adminLinks} title="Pannello Admin">
            ...
            <aside className="hidden border-r border-gray-200 bg-white md:block shadow-lg rounded-r-2xl m-0 md:m-3 md:my-3 md:mr-0 overflow-hidden">
              <div className="flex h-full max-h-screen flex-col">
                ...
                <div className="flex-1 overflow-auto py-6 space-y-4">
                  <SidebarNav links={navItems} pathname={pathname} />
                </div>
