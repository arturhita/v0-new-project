...
// Dati esperti specializzati in Sensitivi & Medium
const psychicExperts = [
  {
    id: 3,
    name: "Cristal Mystic",
...
export default function PsychicPage() {
  ...
  const filteredExperts = psychicExperts
    .filter((expert) => {
      const matchesSearch =
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Connettiti con l'aldilà e ricevi messaggi spirituali dai nostri medium esperti
          </p>
          <div className="flex items-center justify-center space-x-8 text-sm text-gray-600">
            <div className="flex items-center">
              <div className="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></div>
              <span>{psychicExperts.filter((e) => e.status === "online").length} Medium Online</span>
            </div>
            <div className="flex items-center">
        ...
        {filteredExperts.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Nessun medium trovato</h3>
