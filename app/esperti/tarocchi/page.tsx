...
// Dati esperti specializzati in Tarocchi
const tarotExperts = [
  {
    id: 1,
    name: "Luna Stellare",
...
export default function TarotPage() {
  ...
  const filteredExperts = tarotExperts
    .filter((expert) => {
      const matchesSearch =
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Scopri i misteri degli arcani maggiori e minori con i nostri maestri di tarocchi
          </p>
          <div className="flex items-center justify-center space-x-8 text-sm text-gray-600">
            <div className="flex items-center">
              <div className="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></div>
              <span>{tarotExperts.filter((e) => e.status === "online").length} Esperti Online</span>
            </div>
            <div className="flex items-center">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 mb-8 border border-white/20">
          <div className="grid md:grid-cols-4 gap-4">
            <div className="relative">
              ...
              <Input
                placeholder="Cerca esperto tarocchi..."
                value={searchTerm}
        ...
        {filteredExperts.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Nessun esperto di tarocchi trovato</h3>
