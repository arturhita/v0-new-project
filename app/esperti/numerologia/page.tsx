...
// Dati esperti specializzati in Numerologia
const numerologyExperts = [
  {
    id: 4,
...
export default function NumerologyPage() {
  ...
  const filteredExperts = numerologyExperts
    .filter((expert) => {
      const matchesSearch =
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Scopri il significato nascosto dei numeri nella tua vita con i nostri numerologi esperti
          </p>
          <div className="flex items-center justify-center space-x-8 text-sm text-gray-600">
            <div className="flex items-center">
              <div className="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></div>
              <span>{numerologyExperts.filter((e) => e.status === "online").length} Numerologi Online</span>
            </div>
            <div className="flex items-center">
        ...
        {filteredExperts.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Nessun numerologo trovato</h3>
