...
// Dati esperti specializzati in Astrologia
const astrologyExperts = [
  {
    id: 2,
    name: "Maestro Cosmos",
    specialty: "Astrologo",
  ...
  // Aggiungi altri esperti di astrologia...
]
...
export default function AstrologyPage() {
  ...
  const filteredExperts = astrologyExperts
    .filter((expert) => {
      const matchesSearch =
      ...
      const matchesPrice =
        ...
        (priceRange === "medium" && expert.price > 2.5 && expert.price <= 3.5) ||
        (priceRange === "high" && expert.price > 3.5)
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Scopri i segreti delle stelle e dei pianeti con i nostri astrologi professionisti
          </p>
          <div className="flex items-center justify-center space-x-8 text-sm text-gray-600">
            <div className="flex items-center">
              <div className="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></div>
              <span>{astrologyExperts.filter((e) => e.status === "online").length} Astrologi Online</span>
            </div>
            <div className="flex items-center">
              <Star className="h-4 w-4 text-yellow-400 mr-1" />
              <span>4.9/5 Rating Medio</span>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <Select value={priceRange} onValueChange={setPriceRange}>
              ...
              <SelectContent>
                ...
                <SelectItem value="medium">€ 2.50 - 3.50</SelectItem>
                <SelectItem value="high">€ 3.50+</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
        ...
        {filteredExperts.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Nessun astrologo trovato</h3>
