...
// Dati esperti specializzati in Cartomanzia
const cartomancyExperts = [
  {
    id: 1,
    name: "Luna Stellare",
  ...
  // Aggiungi altri esperti di cartomanzia...
]
...
export default function CartomancyPage() {
  ...
  const filteredExperts = cartomancyExperts
    .filter((expert) => {
      const matchesSearch =
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Scopri il tuo futuro attraverso l'antica arte della lettura delle carte con i nostri cartomanti esperti
          </p>
          <div className="flex items-center justify-center space-x-8 text-sm text-gray-600">
            <div className="flex items-center">
              <div className="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></div>
              <span>{cartomancyExperts.filter((e) => e.status === "online").length} Cartomanti Online</span>
            </div>
            <div className="flex items-center">
              <Star className="h-4 w-4 text-yellow-400 mr-1" />
              <span>4.8/5 Rating Medio</span>
            </div>
          </div>
        </div>
        ...
        {filteredExperts.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Nessun cartomante trovato</h3>
