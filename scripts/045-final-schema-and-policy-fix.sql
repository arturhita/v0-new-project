-- =================================================================
-- FINAL SCHEMA AND POLICY FIX SCRIPT
-- This script is designed to be run on a potentially broken schema.
-- It corrects the RLS policy error and ensures the entire financial
-- and administrative backend schema is stable and correct.
-- =================================================================
...
CREATE POLICY "Operators can create and view their own requests" ON public.commission_increase_requests
    FOR ALL USING (operator_id = auth.uid()); -- CORRECTED: Check against auth.uid() directly
