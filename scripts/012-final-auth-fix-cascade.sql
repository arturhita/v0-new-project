-- =================================================================
-- FINAL AUTH FIX SCRIPT (v3 - Resilient)
-- =================================================================
-- This script makes the user creation trigger more robust by checking
-- for multiple possible keys for the user's full name in the metadata.
-- =================================================================
...
-- Step 3: Create the corrected and more resilient function.
...
BEGIN
  ...
  -- Extract full_name from metadata, with a fallback to 'name'.
  -- This makes the trigger more robust against inconsistencies from the client.
